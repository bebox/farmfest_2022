...
note = \relative c'' {
  ...
  \markMoj
  as8 b des as b b r4 |
  des8 c b as ~ as f r f |
  as8 b des as b b r b |
  f'8 es des b as4 r8 as |
  as8 b des as b b r b |
  des8 c b as ~ as f r f |
  as8 b des as b b r b |
  f'8 es des b ~ b as r4 |
  
  \markMojCenter
  \bar ".|:"
  \tuplet 3/2 {as8 as as} \tuplet 3/2 {as8 as as} b8 f r4 |
  ...
  \markMojCenter
  f'8 ges as des, es es r es |
  f8 es des c ~ c b r b |
  f'8 ges as des, es es r es |
  b'8 as f es des4 r8 des8 |
  f8 ges as des, es es r es |
  f8 es des c ~ c b r4 |
  f'8 ges as des, es es r es |
  b'8 as f es ~ es des r4 |
  \bar ":|."
}

tekst = \lyricmode {
  Uz -- dah se u Jah -- vu uz -- da -- njem sil -- nim,
  ...
  Že -- lim sve o -- bja -- vit, al' pre -- vi -- še ih __ je.
}
...
\markup {
  ...
  \huge {
    \rounded-box {
      \line { \pad-to-box #'(0 . 0) #'(-0.34 . 1.85) A \italic \teeny { verse I. } }
      \line { \pad-to-box #'(0 . 0) #'(-0.34 . 1.85) \bold { B \teeny \italic { chorus } } }
      \line { \pad-to-box #'(0 . 0) #'(-0.34 . 0) C \italic \teeny { verse II. } }
